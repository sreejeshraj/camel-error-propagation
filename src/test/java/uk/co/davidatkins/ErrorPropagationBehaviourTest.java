...
public class ErrorPropagationBehaviourTest extends CamelTestSupport {
   ...
   @Test
    ...
    public void ifGenericExceptionInSubRouteWithNoOnException_NotHandledByMainHandler() {
        try {
        	System.out.println("***** BEFORE SUBMITTING REQUEST *****");
        	...
        	System.out.println("***** CAUGHT CamelExecutionException!!! - START ifGenericExceptionInSubRouteWithNoOnException_NotHandledByMainHandler ******");
        	camelExecutionException.printStackTrace();
        	System.out.println("***** CAUGHT CamelExecutionException!!! - END ifGenericExceptionInSubRouteWithNoOnException_NotHandledByMainHandler ******");
    ...
    public void ifGenericExceptionInSubRouteWithNoErrorHandlerAndRouteSpecificOnException_NotHandledByMainHandler() {
        try {
        	...
        	System.out.println("***** CAUGHT CamelExecutionException!!! - START ifGenericExceptionInSubRouteWithNoErrorHandlerAndRouteSpecificOnException_NotHandledByMainHandler ******");
        	camelExecutionException.printStackTrace();
        	System.out.println("***** CAUGHT CamelExecutionException!!! - END ifGenericExceptionInSubRouteWithNoErrorHandlerAndRouteSpecificOnException_NotHandledByMainHandler ******");
